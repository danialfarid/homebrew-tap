class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.14.0/termdeck_agents-0.14.0.tar.gz"
  sha256 "86f811119c1a67d1ae457761184ffd1a7d1c3b5acccb8a769b4898249f3d401d"
  license "Apache-2.0"
  depends_on :macos
