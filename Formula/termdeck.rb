class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.19.4/termdeck_agents-0.19.4.tar.gz"
  sha256 "9c0db4be802dca5f4a836092578d84d553add1277980321602722ec22052aaac"
  license "Apache-2.0"
  depends_on :macos
