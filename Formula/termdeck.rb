class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.19.6/termdeck_agents-0.19.6.tar.gz"
  sha256 "776204984ff93492c72d5c21cc950056337d2eb64f8f912af0abda399e026bba"
  license "Apache-2.0"
  depends_on :macos
