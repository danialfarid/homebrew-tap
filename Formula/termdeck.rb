class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.16.1/termdeck_agents-0.16.1.tar.gz"
  sha256 "ffca4ab40bb71bf4216a7e40efd5cea2012fd4955193d77de28e7d9851ec7ef5"
  license "Apache-2.0"
  depends_on :macos
