class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.20.1/termdeck_agents-0.20.1.tar.gz"
  sha256 "0009b3e8e5c27cd163c51bfe7b3c7d919eacd047c8f44085e3c7d4ca74510d55"
  license "Apache-2.0"
  depends_on :macos
