class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.19.5/termdeck_agents-0.19.5.tar.gz"
  sha256 "eb7e041625c39be909e1125445f444329f8b1e12ea5cd5c5b676790e842d0022"
  license "Apache-2.0"
  depends_on :macos
