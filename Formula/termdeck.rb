class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.12.2/termdeck_agents-0.12.2.tar.gz"
  sha256 "4a1eaf33ab0641616809d5482d9f58b8fed36fe5dcbd99b87c524827848fc2f0"
  license "Apache-2.0"
  depends_on :macos
