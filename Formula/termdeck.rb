class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.19.1/termdeck_agents-0.19.1.tar.gz"
  sha256 "063e577ed9cd0da2aa375c59dc83cb0e89b371e5f360012027f439436dd8892b"
  license "Apache-2.0"
  depends_on :macos
