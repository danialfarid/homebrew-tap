class Termdeck < Formula
  ...
  url "https://github.com/danialfarid/termdeck/releases/download/v0.24.1/termdeck_agents-0.24.1.tar.gz"
  sha256 "d37e42ea531760a2983a4dfc07ae3da7757331223b2048123ddeb369b9e99e75"
  license "Apache-2.0"
  depends_on :macos
